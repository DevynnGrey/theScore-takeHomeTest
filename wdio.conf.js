export const config = {
    ...
    // Currently port is set to 4723, the default for Appium
    runner: 'local',
    port: 4723,
    // Specify Test File Folder
    ...
    capabilities: [{
        ...
        'appium:app': '/Users/shaun/Documents/GitHub/theScore-takeHomeTest/theScore_ Sports News & Scores_24.1.0_Apkpure.apk',
    ...
    logLevel: 'error',
    // If you only want to run your tests until a specific amount of tests have failed. Setting to 0 runs all tests, even with a fail, which is what you want
    bail: 0,
    //
    // Set a base URL in order to shorten url command calls. Not super relevant for this testing right now
    baseUrl: '',
    // Default timeout for all waitFor* commands, which I'm not really using at the moment
    waitforTimeout: 5000,
    // Default timeout in milliseconds for request if the browser/mobile driver or grid doesn't send a response back
    ...
    framework: 'mocha',
    //
    // The number of times to retry the entire specfile when it fails as a whole. Disabled for now
    // specFileRetries: 1,
    //
    ...
    // The rest of this file is boilerplate, however it's very important to leave for scalability and functionality in the future.
    //
    // =====
    // Hooks
    // =====
